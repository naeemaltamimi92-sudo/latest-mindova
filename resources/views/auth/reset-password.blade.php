                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input id="password" type="password" name="password" required
                                   class="w-full pl-9 sm:pl-10 pr-3 sm:pr-4 py-2.5 sm:py-3 bg-white border-2 border-gray-200 rounded-xl focus:border-blue-500 focus:ring-2 focus:ring-blue-200 text-sm sm:text-base text-gray-900 font-medium placeholder-gray-400 @error('password') border-red-500 @enderror"
