...
@section('content')
<div class="max-w-7xl mx-auto px-6 sm:px-8 md:px-10 lg:px-12 xl:px-16 pt-8">
    ...
    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 lg:gap-6 mb-14">
        ...
        <div class="relative group">
            <div class="absolute inset-0 bg-primary-400 rounded-3xl opacity-0 group-hover:opacity-20 blur-xl"></div>
            <div class="relative bg-white rounded-3xl p-5 shadow-sm hover:shadow-lg border border-slate-100 hover:border-indigo-200">
                <div class="flex items-start justify-between mb-3">
                    <div class="flex-1">
                        <p class="text-xs font-bold text-slate-500 mb-2 uppercase tracking-wider">{{ __('Challenges') }}</p>
                        <h3 class="text-3xl font-black text-slate-900 group-hover:text-indigo-600">{{ $company->total_challenges_submitted }}</h3>
                    </div>
                    <div class="w-10 h-10 bg-primary-500 rounded-xl flex items-center justify-center shadow-sm group-hover:shadow-md">
        ...
        <div class="relative group">
            <div class="absolute inset-0 bg-secondary-400 rounded-3xl opacity-0 group-hover:opacity-20 blur-xl"></div>
            <div class="relative bg-white rounded-3xl p-5 shadow-sm hover:shadow-lg border border-slate-100 hover:border-emerald-200">
                <div class="flex items-start justify-between mb-3">
                    <div class="flex-1">
                        <p class="text-xs font-bold text-slate-500 mb-2 uppercase tracking-wider">{{ __('Active') }}</p>
                        <h3 class="text-3xl font-black text-slate-900 group-hover:text-emerald-600">{{ $stats['active_challenges'] ?? 0 }}</h3>
                    </div>
                    <div class="w-10 h-10 bg-secondary-500 rounded-xl flex items-center justify-center shadow-sm group-hover:shadow-md">
                        <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="relative group">
            <div class="absolute inset-0 bg-primary-500 rounded-3xl opacity-0 group-hover:opacity-20 blur-xl"></div>
            <div class="relative bg-white rounded-3xl p-5 shadow-sm hover:shadow-lg border border-slate-100 hover:border-blue-200">
                <div class="flex items-start justify-between mb-3">
                    <div class="flex-1">
                        <p class="text-xs font-bold text-slate-500 mb-2 uppercase tracking-wider">{{ __('In Progress') }}</p>
                        <h3 class="text-3xl font-black text-slate-900 group-hover:text-blue-600">{{ $stats['tasks_in_progress'] ?? 0 }}</h3>
                    </div>
                    <div class="w-10 h-10 bg-primary-500 rounded-xl flex items-center justify-center shadow-sm group-hover:shadow-md">
                        <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="relative group">
            <div class="absolute inset-0 bg-secondary-400 rounded-3xl opacity-0 group-hover:opacity-20 blur-xl"></div>
            <div class="relative bg-white rounded-3xl p-5 shadow-sm hover:shadow-lg border border-slate-100 hover:border-violet-200">
                <div class="flex items-start justify-between mb-3">
                    <div class="flex-1">
                        <p class="text-xs font-bold text-slate-500 mb-2 uppercase tracking-wider">{{ __('Completed') }}</p>
                        <h3 class="text-3xl font-black text-slate-900 group-hover:text-violet-600">{{ $stats['completed_tasks'] ?? 0 }}</h3>
                    </div>
                    <div class="w-10 h-10 bg-secondary-500 rounded-xl flex items-center justify-center shadow-sm group-hover:shadow-md">
                        <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="relative group">
            <div class="absolute inset-0 bg-secondary-500 rounded-3xl opacity-0 group-hover:opacity-20 blur-xl"></div>
            <div class="relative bg-white rounded-3xl p-5 shadow-sm hover:shadow-lg border border-slate-100 hover:border-teal-200">
                <div class="flex items-start justify-between mb-3">
                    <div class="flex-1">
                        <p class="text-xs font-bold text-slate-500 mb-2 uppercase tracking-wider">{{ __('Contributors') }}</p>
                        <h3 class="text-3xl font-black text-slate-900 group-hover:text-teal-600">{{ $stats['total_volunteers_working'] ?? 0 }}</h3>
                    </div>
                    <div class="w-10 h-10 bg-secondary-500 rounded-xl flex items-center justify-center shadow-sm group-hover:shadow-md">
        ...
        <div class="relative group">
            <div class="absolute inset-0 bg-secondary-300 rounded-3xl opacity-0 group-hover:opacity-20 blur-xl"></div>
            <div class="relative bg-white rounded-3xl p-5 shadow-sm hover:shadow-lg border border-slate-100 hover:border-amber-200">
                <div class="flex items-start justify-between mb-3">
                    <div class="flex-1">
                        <p class="text-xs font-bold text-slate-500 mb-2 uppercase tracking-wider">{{ __('Solutions') }}</p>
                        <h3 class="text-3xl font-black text-slate-900 group-hover:text-amber-600">{{ $stats['total_approved_solutions'] ?? 0 }}</h3>
                    </div>
                    <div class="w-10 h-10 bg-secondary-500 rounded-xl flex items-center justify-center shadow-sm group-hover:shadow-md">
                        <svg class="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 20 20">
    ...
    <div class="mb-10">
        <div class="flex items-center justify-between mb-10">
            ...
            <x-ui.button as="a" href="{{ route('challenges.index') }}" variant="primary" class="rounded-2xl">
        ...
        <div class="grid grid-cols-1 gap-8">
            ...
            <div class="group relative bg-white rounded-3xl p-8 md:p-10 shadow-sm hover:shadow-xl border border-slate-100 hover:border-indigo-200" style="animation-delay: {{ 0.1 * ($index + 1) }}s;">
                ...
                <div class="relative flex justify-between items-start mb-6">
                    <div class="flex-1 pr-6">
                        <div class="flex items-center gap-3 flex-wrap mb-4">
                            <h3 class="text-2xl font-black text-slate-900 group-hover:text-indigo-600">{{ $challenge->title }}</h3>
                    ...
                    <x-ui.button as="a" href="{{ route('challenges.show', $challenge->id) }}" variant="primary" class="whitespace-nowrap">
                ...
                <div class="relative mb-6 p-6 bg-gray-50 border border-blue-200 rounded-2xl shadow-sm">
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="flex items-center text-xs sm:text-sm">
                            ...
                            @else
                                <svg class="w-4 h-4 sm:w-5 sm:h-5 text-yellow-500 mr-2 sm:mr-3 flex-shrink-0" fill="none" viewBox="0 0 24 24">
                ...
                <div class="relative mb-6 p-6 bg-gray-50 border border-emerald-200 rounded-2xl shadow-sm">
                            ...
                            <div class="w-full bg-slate-200 rounded-full h-3 overflow-hidden">
                                @php
                                    $solutionPercentage = $challenge->tasks()->count() > 0
                                        ...
                                        : 0;
                                @endphp
                                <div class="h-full rounded-full bg-secondary-500"
                            ...
                            @if($challenge->avg_submission_quality)
                                <div class="w-full bg-slate-200 rounded-full h-3 overflow-hidden">
                                    <div class="h-full rounded-full
                                        @if($challenge->avg_submission_quality >= 8) bg-secondary-500
                                        @elseif($challenge->avg_submission_quality >= 6) bg-primary-500
                                        @elseif($challenge->avg_submission_quality >= 4) bg-secondary-300
                    ...
                    <div class="mt-4 pt-4 border-t border-emerald-200">
                        <a href="{{ route('challenges.show', $challenge->id) }}" class="inline-flex items-center text-sm font-semibold text-emerald-700 hover:text-emerald-800">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8 p-7 bg-gray-50 rounded-2xl border border-slate-200 mb-6 shadow-sm">
        ...
        <div class="relative bg-gray-50 rounded-3xl p-16 text-center shadow-sm border border-slate-200 overflow-hidden">
            ...
            <!-- Content -->
            <div class="relative">
                <div class="w-24 h-24 bg-primary-500 rounded-3xl flex items-center justify-center mx-auto mb-6 shadow-lg transform">
                ...
                <x-ui.button as="a" href="{{ route('challenges.create') }}" variant="primary" size="lg" class="rounded-2xl">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
