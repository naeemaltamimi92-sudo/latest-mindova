...
<div class="max-w-7xl mx-auto px-4 lg:px-8 pb-12 pt-6">
    ...
    <div class="relative overflow-hidden rounded-2xl mb-6" style="background: linear-gradient(135deg, #775FEE 0%, #5A3DEB 50%, #4338CA 100%);">
        <div class="absolute inset-0 opacity-10">
            <svg class="w-full h-full" viewBox="0 0 800 200" preserveAspectRatio="xMidYMid slice" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <circle cx="650" cy="100" r="140" stroke="white" stroke-width="1"/>
                <circle cx="650" cy="100" r="80" stroke="white" stroke-width="1"/>
                <circle cx="100" cy="20" r="80" stroke="white" stroke-width="0.5"/>
            </svg>
        </div>
        <div class="relative px-6 py-7 lg:px-10">
            <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
                <div class="flex items-center gap-5">
                    <div class="w-16 h-16 rounded-2xl bg-white/20 flex items-center justify-center flex-shrink-0 border border-white/30">
                        <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/>
                        </svg>
                    </div>
                    <div>
                        <p class="text-white/75 text-sm font-medium">{{ __('Welcome back') }}</p>
                        <h1 class="text-2xl lg:text-3xl font-bold text-white leading-tight">{{ $company->name }}</h1>
                        <p class="text-white/70 text-sm mt-0.5">{{ auth()->user()->name }}</p>
                    </div>
                </div>
                <div class="flex items-center gap-3 flex-wrap lg:flex-nowrap">
                    <div class="bg-white/15 border border-white/25 rounded-xl px-5 py-3 text-center min-w-[90px]">
                        <p class="text-2xl font-bold text-white">{{ $company->total_challenges_submitted }}</p>
                        <p class="text-white/70 text-xs font-medium">{{ __('Challenges') }}</p>
                    </div>
                    <div class="bg-white/15 border border-white/25 rounded-xl px-5 py-3 text-center min-w-[90px]">
                        <p class="text-2xl font-bold text-white">{{ $stats['active_challenges'] ?? 0 }}</p>
                        <p class="text-white/70 text-xs font-medium">{{ __('Active') }}</p>
                    </div>
                    <div class="bg-white/15 border border-white/25 rounded-xl px-5 py-3 text-center min-w-[90px]">
                        <p class="text-2xl font-bold text-white">{{ $stats['tasks_in_progress'] ?? 0 }}</p>
                        <p class="text-white/70 text-xs font-medium">{{ __('In Progress') }}</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-3 mb-6">
        <a href="{{ route('challenges.create') }}" class="bg-white border border-gray-200 rounded-xl p-4 text-center hover:border-primary-300 hover:shadow-sm transition-all group">
            <div class="w-10 h-10 bg-primary-50 group-hover:bg-primary-100 rounded-lg flex items-center justify-center mx-auto mb-2 transition-colors">
            ...
            <p class="font-semibold text-gray-900 text-xs">{{ __('New Challenge') }}</p>
        </a>
        <a href="{{ route('challenges.index') }}" class="bg-white border border-gray-200 rounded-xl p-4 text-center hover:border-violet-300 hover:shadow-sm transition-all group">
            <div class="w-10 h-10 bg-violet-50 group-hover:bg-violet-100 rounded-lg flex items-center justify-center mx-auto mb-2 transition-colors">
            ...
            <p class="font-semibold text-gray-900 text-xs">{{ __('All Challenges') }}</p>
        </a>
        <a href="{{ route('community.index') }}" class="bg-white border border-gray-200 rounded-xl p-4 text-center hover:border-emerald-300 hover:shadow-sm transition-all group">
            ...
            <p class="font-semibold text-gray-900 text-xs">{{ __('Community') }}</p>
        </a>
        <a href="{{ route('profile.edit') }}" class="bg-white border border-gray-200 rounded-xl p-4 text-center hover:border-gray-400 hover:shadow-sm transition-all group">
            <div class="w-10 h-10 bg-gray-100 group-hover:bg-gray-200 rounded-lg flex items-center justify-center mx-auto mb-2 transition-colors">
            ...
            <p class="font-semibold text-gray-900 text-xs">{{ __('Settings') }}</p>
        </a>
    </div>
    ...
    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3 mb-6">
        <div class="bg-white rounded-xl border border-gray-200 p-4 hover:shadow-sm transition-shadow">
            <div class="w-9 h-9 bg-primary-100 rounded-lg flex items-center justify-center mb-3">
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-4 hover:shadow-sm transition-shadow">
            <div class="w-9 h-9 bg-cyan-100 rounded-lg flex items-center justify-center mb-3">
                <svg class="w-4 h-4 text-cyan-600" fill="currentColor" viewBox="0 0 20 20"><path d="M13 6a3 3 0 11-6 0 3 3 0 016 0zM18 8a2 2 0 11-4 0 2 2 0 014 0zM14 15a4 4 0 00-8 0v3h8v-3z"/></svg>
            </div>
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-4 hover:shadow-sm transition-shadow">
            <div class="w-9 h-9 bg-amber-100 rounded-lg flex items-center justify-center mb-3">
                <svg class="w-4 h-4 text-amber-600" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M6.267 3.455a3.066 3.066 0 001.745-.723 3.066 3.066 0 013.976 0 3.066 3.066 0 001.745.723 3.066 3.066 0 012.812 2.812c.051.643.304 1.254.723 1.745a3.066 3.066 0 010 3.976 3.066 3.066 0 00-.723 1.745 3.066 3.066 0 01-2.812 2.812 3.066 3.066 0 00-1.745.723 3.066 3.066 0 01-3.976 0 3.066 3.066 0 00-1.745-.723 3.066 3.066 0 01-2.812-2.812 3.066 3.066 0 00-.723-1.745 3.066 3.066 0 010-3.976 3.066 3.066 0 00.723-1.745 3.066 3.066 0 012.812-2.812zm7.44 5.252a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/></svg>
            </div>
            ...
            <div class="p-6">
                ...
                <div class="bg-gray-50 rounded-lg border border-gray-200 p-4 mb-4">
                    ...
                    <div class="space-y-2">
                        <div class="flex items-center text-sm">
                            ...
                            @else
                                <svg class="w-4 h-4 text-amber-500 mr-2 flex-shrink-0" fill="none" viewBox="0 0 24 24"><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"/><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"/></svg>
                        ...
                        <div class="flex items-center text-sm">
                            ...
                            @else
                                <svg class="w-4 h-4 text-gray-400 mr-2 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM8 7a1 1 0 000 2h4a1 1 0 100-2H8z"/></svg>
                ...
                <div class="bg-emerald-50 rounded-lg border border-emerald-200 p-4 mb-4">
                        ...
                        <div class="bg-white rounded-lg p-3 border border-emerald-100">
                            <div class="flex items-center gap-2 mb-1">
                                <div class="w-6 h-6 bg-blue-100 rounded flex items-center justify-center">
                                    <svg class="w-3 h-3 text-blue-600" fill="currentColor" viewBox="0 0 20 20"><path d="M13 6a3 3 0 11-6 0 3 3 0 016 0zM18 8a2 2 0 11-4 0 2 2 0 014 0zM14 15a4 4 0 00-8 0v3h8v-3z"/></svg>
                                </div>
                        ...
                        <div class="bg-white rounded-lg p-3 border border-emerald-100">
                            <div class="flex items-center gap-2 mb-1">
                                <div class="w-6 h-6 bg-amber-100 rounded flex items-center justify-center">
                                    <svg class="w-3 h-3 text-amber-600" fill="currentColor" viewBox="0 0 20 20"><path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z"/><path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z"/></svg>
                                </div>
                        ...
                        <div class="bg-white rounded-lg p-3 border border-emerald-100">
                            <div class="flex items-center gap-2 mb-1">
                                <div class="w-6 h-6 bg-violet-100 rounded flex items-center justify-center">
                                    <svg class="w-3 h-3 text-violet-600" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M4 4a2 2 0 012-2h4.586A2 2 0 0112 2.586L15.414 6A2 2 0 0116 7.414V16a2 2 0 01-2 2H6a2 2 0 01-2-2V4z" clip-rule="evenodd"/></svg>
                                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                        <div class="bg-white rounded-lg p-3 border border-emerald-100">
                            ...
                            @php $solutionPercentage = $challenge->tasks()->count() > 0 ? round(($challenge->tasks_with_solutions / $challenge->tasks()->count()) * 100) : 0; @endphp
                            ...
                            <div class="flex items-center justify-between mb-2">
                                ...
                                @if($challenge->avg_submission_quality)
                                    <span class="text-sm font-bold
                                        ...
                                        @else text-red-600
                                        @endif">{{ $challenge->avg_submission_quality }}/100</span>
                                @else
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 p-4 bg-gray-50 rounded-lg border border-gray-200 mb-4">
                    <div class="flex flex-col items-center">
                        <x-progress-circle :percentage="$challenge->progress_percentage" :size="80" color="#5A3DEB"/>
                        <p class="text-xs text-gray-500 mt-2 font-medium">{{ __('Task Completion') }}</p>
                        <p class="text-sm font-bold text-gray-900">{{ $challenge->tasks()->where('status', 'completed')->count() }} / {{ $challenge->tasks()->count() }}</p>
                    </div>
                    <div class="flex flex-col items-center">
                        <x-progress-circle :percentage="$challenge->performance_score" :size="80" color="#10b981"/>
                        <p class="text-xs text-gray-500 mt-2 font-medium">{{ __('Performance Score') }}</p>
                        @php $healthStatus = $challenge->health_status; $healthColors = ['on_track' => 'text-emerald-600', 'at_risk' => 'text-amber-600', 'behind' => 'text-red-600']; @endphp
                        <p class="text-sm font-bold {{ $healthColors[$healthStatus] ?? 'text-gray-600' }}">{{ ucfirst(str_replace('_', ' ', $healthStatus)) }}</p>
                    </div>
                    <div class="flex flex-col items-center">
                        <x-progress-circle :percentage="$challenge->time_based_progress" :size="80" color="#8b5cf6"/>
                ...
                <div class="flex items-center flex-wrap gap-4 text-xs text-gray-600">
                    ...
                    <span class="inline-flex items-center gap-1.5">
                        <svg class="w-3.5 h-3.5 text-amber-500" fill="currentColor" viewBox="0 0 20 20"><path d="M2 11a1 1 0 011-1h2a1 1 0 011 1v5a1 1 0 01-1 1H3a1 1 0 01-1-1v-5zM8 7a1 1 0 011-1h2a1 1 0 011 1v9a1 1 0 01-1 1H9a1 1 0 01-1-1V7zM14 4a1 1 0 011-1h2a1 1 0 011 1v12a1 1 0 01-1 1h-2a1 1 0 01-1-1V4z"/></svg>
                        {{ __('Level') }} {{ $challenge->complexity_level }}
                    </span>
                    @endif
                    @if($challenge->challenge_type)
                    <span class="inline-flex items-center gap-1.5">
                        <svg class="w-3.5 h-3.5 text-primary-500" fill="currentColor" viewBox="0 0 20 20"><path d="M2 6a2 2 0 012-2h5l2 2h5a2 2 0 012 2v6a2 2 0 01-2 2H4a2 2 0 01-2-2V6z"/></svg>
                        {{ ucfirst(str_replace('_', ' ', $challenge->challenge_type)) }}
                    </span>
                    @endif
                    @if($challenge->total_estimated_hours > 0)
                    <span class="inline-flex items-center gap-1.5">
                        <svg class="w-3.5 h-3.5 text-blue-500" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-12a1 1 0 10-2 0v4a1 1 0 00.293.707l2.828 2.829a1 1 0 101.415-1.415L11 9.586V6z" clip-rule="evenodd"/></svg>
                        {{ __(':hours h total', ['hours' => $challenge->total_estimated_hours]) }}
                    </span>
                    @endif
                    <span class="inline-flex items-center gap-1.5">
                        <svg class="w-3.5 h-3.5 text-gray-400" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a1 1 0 000 2h8a1 1 0 100-2H6z" clip-rule="evenodd"/></svg>
