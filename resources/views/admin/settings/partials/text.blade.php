...
<div x-data="{ value: '{{ $escapedValue }}', saving: false, originalValue: '{{ $escapedValue }}' }" class="flex items-center gap-2">
    <input
        ...
        "
        class="w-64 px-3.5 py-2 text-sm font-medium text-slate-900 bg-white border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-500/30 focus:border-primary-500 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
