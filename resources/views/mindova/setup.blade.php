            ...
            <form action="{{ route('mindova.setup.submit') }}" method="POST" class="space-y-5">
                ...
                <div>
                    ...
                    <input type="text" id="name" name="name" value="{{ old('name') }}" required autofocus
                        class="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('name') border-red-500 @enderror"
                ...
                <div>
                    ...
                    <input type="password" id="setup_key" name="setup_key" required
                        class="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('setup_key') border-red-500 @enderror"
