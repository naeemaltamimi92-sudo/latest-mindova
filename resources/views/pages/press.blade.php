    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center">
            <div class="inline-flex items-center gap-2 bg-white border border-gray-200 rounded-full px-4 py-1.5 mb-6">
                ...
                <span class="text-sm font-medium text-gray-700">{{ __('Press') }}</span>
            </div>

            <h1 class="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                {{ __('Mindova') }} <span class="text-primary-600">{{ __('Press Kit') }}</span>
            </h1>
...
<section class="py-16 bg-white">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        <div class="bg-gray-50 border border-gray-200 rounded-xl p-8">
            <h2 class="text-xl font-bold text-gray-900 mb-3">{{ __('Boilerplate') }}</h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="bg-white border border-gray-200 rounded-xl p-6">
                ...
                <h3 class="text-lg font-semibold text-gray-900 mb-2">{{ __('Brand Assets') }}</h3>
                <p class="text-gray-600 text-sm">{{ __('Logos and wordmarks are available on request while we finalize a public downloadable kit. Please use the logo unmodified and avoid recoloring it.') }}</p>
            </div>
            <div class="bg-white border border-gray-200 rounded-xl p-6">
                ...
                <h3 class="text-lg font-semibold text-gray-900 mb-2">{{ __('Media Inquiries') }}</h3>
                <p class="text-gray-600 text-sm">{{ __('For interviews, data requests, or commentary, contact us and a team member will follow up directly.') }}</p>
            </div>
        </div>
