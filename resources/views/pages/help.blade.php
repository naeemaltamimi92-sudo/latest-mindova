...
<section class="py-24 bg-primary-500 text-white relative overflow-hidden">
    ...
    <div class="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p class="text-xl text-white/90 mb-10" style="color: rgba(255, 255, 255, 0.9) !important;">{{ __('Join our community and start transforming challenges into innovation') }}</p>
