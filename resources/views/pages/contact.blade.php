...
<div class="relative overflow-hidden bg-gray-50 pt-32 pb-24">
    ...
    <div class="floating-element absolute top-20 right-0 w-96 h-96 bg-primary-500 opacity-20 rounded-full blur-3xl"></div>
    <div class="floating-element absolute -bottom-20 left-0 w-[32rem] h-[32rem] bg-primary-400 opacity-20 rounded-full blur-3xl"></div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div class="animate-slide-in-up">
                ...
                <div class="space-y-6">
                    ...
                    <div class="card-premium">
                        <div class="flex items-start">
                            <div class="icon-badge bg-primary-400 mr-4 flex-shrink-0">
                                <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="mt-10 card-premium bg-gray-50 border-2 border-blue-200">
            ...
            <!-- Contact Form -->
            <div class="animate-slide-in-up">
                <div class="card-premium bg-gray-50 border-2 border-blue-100 px-6 sm:px-8 md:px-10 lg:px-12 xl:px-14 py-8 sm:py-10 md:py-12">
                    ...
                    <form action="#" method="POST" class="space-y-5 sm:space-y-6 md:space-y-7">
                        ...
                        <div>
                            ...
                            <input type="text" name="name" required class="w-full px-4 py-3 bg-white border-2 border-gray-200 rounded-xl focus:border-blue-500 focus:ring-2 focus:ring-blue-200 text-sm sm:text-base" placeholder="{{ __('Your name') }}">
                        </div>

                        <div>
                            <label class="block text-xs sm:text-sm font-bold text-gray-900 mb-2 sm:mb-2.5">{{ __('Email') }}</label>
                            <input type="email" name="email" required class="w-full px-4 py-3 bg-white border-2 border-gray-200 rounded-xl focus:border-blue-500 focus:ring-2 focus:ring-blue-200 text-sm sm:text-base" placeholder="{{ __('your@email.com') }}">
                        </div>

                        <div>
                            <label class="block text-xs sm:text-sm font-bold text-gray-900 mb-2 sm:mb-2.5">{{ __('Subject') }}</label>
                            <select name="subject" class="w-full px-4 py-3 bg-white border-2 border-gray-200 rounded-xl focus:border-blue-500 focus:ring-2 focus:ring-blue-200 text-sm sm:text-base">
                        ...
                        <div>
                            ...
                            <textarea name="message" rows="6" required class="w-full px-4 py-3 bg-white border-2 border-gray-200 rounded-xl focus:border-blue-500 focus:ring-2 focus:ring-blue-200 resize-none text-sm sm:text-base" placeholder="{{ __('Tell us how we can help...') }}"></textarea>
                        </div>
...
<section class="py-20 bg-primary-500 text-white relative overflow-hidden">
    ...
    <div class="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <x-ui.button as="a" href="{{ route('help') }}" variant="secondary" size="lg">
