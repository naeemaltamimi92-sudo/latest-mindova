...
<div class="relative overflow-hidden bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 pt-32 pb-24">
    ...
    <div class="floating-element absolute top-20 -left-32 w-96 h-96 bg-gradient-blue opacity-20 rounded-full blur-3xl animate-float" style="animation-delay: 0s;"></div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
            ...
            <div class="card-premium text-center animate-slide-in-up" style="animation-delay: 0.2s;">
                <div class="icon-badge bg-gradient-green mx-auto mb-6">
                    <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="card-premium text-center animate-slide-in-up" style="animation-delay: 0.3s;">
                <div class="icon-badge bg-gradient-purple mx-auto mb-6">
                    <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="card-premium text-center animate-slide-in-up" style="animation-delay: 0.4s;">
                <div class="icon-badge bg-gradient-orange mx-auto mb-6">
                    <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="card-premium bg-gradient-to-br from-blue-50 to-purple-50 border-2 border-blue-200 animate-slide-in-up" style="animation-delay: 0.5s;">
...
<section class="py-20 bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-5 gap-6 mb-12">
            ...
            <div class="card-premium text-center animate-slide-in-up" style="animation-delay: 0.5s;">
                <div class="icon-badge bg-gradient-blue mx-auto mb-4">
                    <svg class="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="card-premium bg-gradient-to-br from-green-50 to-emerald-50 border-2 border-green-200 animate-slide-in-up" style="animation-delay: 0.6s;">
            <h4 class="text-2xl font-bold text-gray-900 mb-6 flex items-center">
...
<section class="py-20 bg-gradient-to-br from-purple-50 via-pink-50 to-orange-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="card-premium bg-gradient-to-br from-purple-50/80 to-pink-50/80 backdrop-blur-lg border-2 border-purple-200">
...
<section class="py-24 bg-gradient-animated text-white relative overflow-hidden">
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div class="flex flex-col sm:flex-row justify-center gap-4">
            <a href="{{ route('register') }}" class="group relative overflow-hidden bg-white text-blue-600 hover:text-blue-700 font-semibold text-lg px-10 py-4 rounded-xl transition-all transform hover:scale-105 shadow-2xl">
            ...
            <a href="{{ route('register') }}" class="group relative overflow-hidden bg-white/20 backdrop-blur-sm border-2 border-white hover:bg-white/30 text-white font-semibold text-lg px-10 py-4 rounded-xl transition-all transform hover:scale-105 shadow-2xl">
                {{ __('Post a Challenge') }}
                <svg class="inline-block w-5 h-5 ml-2 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6"></path>
                </svg>
