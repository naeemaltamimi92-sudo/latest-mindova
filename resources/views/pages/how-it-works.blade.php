...
@section('content')
<!-- Hero Section -->
<div class="relative overflow-hidden pt-24 pb-20 border-b border-gray-200" style="background:linear-gradient(135deg,#EDE9FD 0%,#F5F3FF 50%,#EEF2FF 100%);">
    <div class="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center">
            <div class="inline-flex items-center gap-2 bg-white border border-primary-100 rounded-full px-4 py-2 mb-6 shadow-sm">
                <div class="w-2 h-2 bg-emerald-500 rounded-full"></div>
                <span class="text-sm font-medium text-gray-600">{{ __('Complete Guide to Mindova') }}</span>
            </div>

            <h1 class="text-display text-gray-900 mb-5">
...
<section class="py-16 bg-gray-50 border-t border-gray-200">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-10">
            <div class="bg-white border border-gray-200 rounded-xl p-5 text-center transition-premium hover:shadow-md">
...
<section class="py-16 border-t border-gray-200">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4 mb-10">
            <div class="bg-white border border-gray-200 rounded-xl p-4 text-center transition-premium hover:shadow-md">
