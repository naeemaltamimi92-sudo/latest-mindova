...
<div class="min-h-screen bg-gray-50">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12 mt-4">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 mb-6 overflow-hidden">
            <div class="px-5 py-4 border-b border-gray-100 dark:border-gray-700 flex flex-col md:flex-row md:items-center justify-between gap-3">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h3 class="text-base font-semibold text-gray-900 dark:text-white">{{ __('Your Assignment') }}</h3>
                        <p class="text-gray-500 text-xs">{{ __('Current Status:') }} <span class="font-medium text-gray-700 dark:text-gray-300">{{ ucfirst(str_replace('_', ' ', $myAssignment->invitation_status)) }}</span></p>
                    </div>
                </div>
            ...
            <div class="p-4 bg-gray-50 dark:bg-gray-900/40">
                ...
                <div class="bg-white dark:bg-gray-800 border border-amber-200 dark:border-amber-800/50 rounded-xl p-4">
                    <div class="flex items-start gap-3">
                        <div class="text-lg">⚠️</div>
                        <div class="flex-1">
                            <h4 class="font-semibold text-gray-900 dark:text-white">{{ __('Revision Required') }}</h4>
                ...
                <div class="bg-white dark:bg-gray-800 border border-emerald-200 dark:border-emerald-800/50 rounded-xl p-4">
                    <div class="flex items-start gap-3">
                        <div class="text-lg">✅</div>
                        <div class="flex-1">
                            <h4 class="font-semibold text-gray-900 dark:text-white">{{ __('Excellent Work!') }}</h4>
                            <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">{{ __('Your solution has been approved.') }}</p>
                        </div>
                    </div>
                </div>
                @elseif($latestSubmission->status === 'submitted')
                 <div class="bg-white dark:bg-gray-800 border border-blue-200 dark:border-blue-800/50 rounded-xl p-4 text-center">
                    <div class="inline-block w-5 h-5 text-blue-600">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/>
                        </svg>
                    </div>
                    <p class="text-sm text-gray-600 dark:text-gray-400 mt-2">{{ __('The company is reviewing your submission...') }}</p>
                </div>
                @endif
            </div>
            @endif
        ...
        <div class="grid lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
                    <div class="bg-gray-50 dark:bg-gray-900/40 px-5 py-4 border-b border-gray-100 dark:border-gray-700">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <h2 class="text-base font-semibold text-gray-900 dark:text-white">{{ __('Task Description') }}</h2>
                                <p class="text-xs text-gray-500">{{ __('Overview of what needs to be done') }}</p>
                            </div>
                        </div>
                    </div>
                    <div class="p-5">
                        <p class="text-gray-700 dark:text-gray-300 text-sm leading-relaxed whitespace-pre-line">{{ $task->description }}</p>
                    </div>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
                    <div class="bg-gray-50 dark:bg-gray-900/40 px-5 py-4 border-b border-gray-100 dark:border-gray-700">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <h2 class="text-base font-semibold text-gray-900 dark:text-white">{{ __('AI-Analyzed Task Requirements') }}</h2>
                    ...
                    <div class="p-5 space-y-4">
                        ...
                        <div class="grid md:grid-cols-2 gap-4">
                            ...
                            <div class="bg-gray-50 dark:bg-gray-900/40 rounded-xl p-4 border border-gray-200 dark:border-gray-700">
                                <div class="flex items-center gap-2 mb-3">
                                    ...
                                    <h3 class="font-semibold text-gray-900 dark:text-white text-sm">{{ __('What to Deliver') }}</h3>
                                </div>
                                <p class="text-gray-700 dark:text-gray-300 text-sm leading-relaxed">{{ $task->expected_output }}</p>
                            </div>
                            ...
                            <div class="bg-gray-50 dark:bg-gray-900/40 rounded-xl p-4 border border-gray-200 dark:border-gray-700">
                                <div class="flex items-center gap-2 mb-3">
                                    ...
                                    <h3 class="font-semibold text-gray-900 dark:text-white text-sm">{{ __('Complexity & Priority') }}</h3>
                                </div>
                                <div class="space-y-3">
                                    <!-- Complexity Level -->
                                    <div>
                                        ...
                                        <div class="flex items-center gap-2 mb-1">
                                            <span class="text-xl font-bold text-gray-900 dark:text-white">{{ $task->complexity_score }}</span>
                        ...
                        <div class="bg-gray-50 dark:bg-gray-900/40 rounded-xl p-4 border border-gray-200 dark:border-gray-700">
                            <div class="flex items-center justify-between mb-3">
                                <div class="flex items-center gap-2">
                                    ...
                                    <h3 class="font-semibold text-gray-900 dark:text-white text-sm">{{ __('Success Criteria') }}</h3>
                                </div>
                                <span class="text-xs text-gray-400 font-medium">{{ __('Must meet all criteria') }}</span>
                            </div>
                            <div class="space-y-2">
                                @foreach($task->acceptance_criteria as $criteria)
                                <div class="flex items-start gap-2 p-3 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
                                    <div class="flex-shrink-0 w-4 h-4 mt-0.5 border border-emerald-400 rounded bg-white dark:bg-gray-800"></div>
                                    <p class="text-sm text-gray-700 dark:text-gray-300 flex-1">{{ $criteria }}</p>
                                </div>
                                @endforeach
                            </div>
                        </div>
                        ...
                        <div class="bg-gray-50 dark:bg-gray-900/40 rounded-xl p-4 border border-gray-200 dark:border-gray-700">
                            <div class="flex items-center gap-2 mb-3">
                                ...
                                <h3 class="font-semibold text-gray-900 dark:text-white text-sm">{{ __('Required Skills') }}</h3>
                            </div>
                            <div class="flex flex-wrap gap-1.5">
                                @foreach($task->required_skills as $skill)
                                <span class="px-2.5 py-1 bg-white dark:bg-gray-800 text-violet-700 dark:text-violet-300 rounded-lg text-xs font-medium border border-violet-200 dark:border-violet-800/50">
                                    {{ $skill }}
                                </span>
                                @endforeach
                            </div>
                ...
                @if($isTeamLeader)
                <!-- Team Leader View -->
                <div class="bg-blue-50 dark:bg-blue-950/30 rounded-xl border border-blue-200 dark:border-blue-800/50 overflow-hidden">
                    <div class="px-5 py-4 border-b border-blue-200 dark:border-blue-800/50 flex items-center gap-2">
                        ...
                        <div>
                            <h3 class="font-semibold text-gray-900 dark:text-white text-sm">{{ __('Team Leader View') }}</h3>
                            <p class="text-xs text-blue-700 dark:text-blue-300">{{ __('You can see the full challenge context as a team manager.') }}</p>
                        </div>
                    </div>
                    <div class="p-4">
                        <div class="flex justify-between items-center">
                            <div>
                                <h4 class="font-semibold text-gray-900 dark:text-white text-sm mb-0.5">{{ $task->challenge->title }}</h4>
                                <p class="text-xs text-gray-600 dark:text-gray-400">{{ Str::limit($task->challenge->refined_brief, 120) }}</p>
                            </div>
            ...
            <div class="space-y-4">
                <!-- Task Info Card -->
                <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
                    <div class="bg-gray-50 dark:bg-gray-900/40 px-4 py-3 border-b border-gray-100 dark:border-gray-700">
                        <h3 class="font-semibold text-gray-900 dark:text-white flex items-center gap-2 text-sm">
                    ...
                    <div class="p-4 space-y-4">
                        <div>
                            ...
                            <p class="text-xl font-bold text-primary-600 dark:text-primary-400">{{ $task->estimated_hours }} <span class="text-sm font-medium text-gray-500">{{ __('hours') }}</span></p>
                        </div>
                        ...
                        <div>
                            ...
                            <p class="text-base font-semibold text-gray-900 dark:text-white">{{ $task->deadline->translatedFormat('M d, Y') }}</p>
                        </div>
                        @endif
                        ...
                        <div>
                            ...
                            <p class="text-base font-semibold text-gray-900 dark:text-white">{{ $task->workstream->title }}</p>
                        </div>
                        @endif
                    </div>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
                    ...
                    <div class="p-3 space-y-2">
                        ...
                        <div class="flex items-center gap-2 p-2 bg-gray-50 dark:bg-gray-900/40 rounded-lg border border-gray-100 dark:border-gray-700">
                            ...
                            <div class="flex-1">
                                <p class="text-sm font-medium text-gray-900 dark:text-white">{{ $assignment->volunteer->user->name }}</p>
...
<div id="submitSolutionModal" class="hidden fixed inset-0 bg-gray-900/70 z-50 overflow-y-auto">
    <div class="relative top-20 mx-auto p-0 w-full max-w-2xl px-4">
        <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 elevation-xl overflow-hidden animate-fade-in">
            <div class="bg-gray-50 dark:bg-gray-900/40 px-6 py-4 border-b border-gray-100 dark:border-gray-700">
                <h3 class="text-lg font-semibold text-gray-900 dark:text-white">{{ __('Submit Your Solution') }}</h3>
            ...
            <form id="submitSolutionForm" method="POST" action="" enctype="multipart/form-data" class="p-6">
                ...
                <div class="space-y-4">
                    <div>
                        <label class="block text-sm font-semibold text-gray-900 dark:text-white mb-1.5">{{ __('Solution Description') }} *</label>
                    ...
                    <div>
                        <label class="block text-sm font-semibold text-gray-900 dark:text-white mb-1.5">{{ __('Deliverable URL') }}</label>
                    ...
                    <div>
                        <label class="block text-sm font-semibold text-gray-900 dark:text-white mb-1.5">{{ __('Attachments (Optional)') }}</label>
                    ...
                    <div>
                        <label class="block text-sm font-semibold text-gray-900 dark:text-white mb-1.5">{{ __('Hours Worked') }} *</label>
                    ...
                    <div class="bg-blue-50 dark:bg-blue-950/30 rounded-lg p-4 border border-blue-200 dark:border-blue-800/50">
