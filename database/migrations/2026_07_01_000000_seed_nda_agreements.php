...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        DB::table('nda_agreements')->updateOrInsert(
            ...
            [
                ...
                'version' => '1.0',
                'content' => $this->challengeNdaContent(),
                'effective_date' => now(),
                'updated_at' => now(),
                'created_at' => now(),
            ]
    ...
    {
        DB::table('nda_agreements')->where('type', 'general')->where('version', '1.0')->delete();
        DB::table('nda_agreements')->where('type', 'challenge_specific')->where('version', '1.0')->delete();
    }

    private function generalNdaContent(): string
    {
        return <<<'NDA'
...
NDA;
    ...
    private function challengeNdaContent(): string
    {
        return <<<'NDA'
